...
```typescript
import { IdempotencyConflictError } from "@auditlocker/sdk/models/errors";
...
| `status`                                                                                   | [models.IdempotencyConflictErrorStatus](../../models/idempotency-conflict-error-status.md) | :heavy_check_mark:                                                                         | N/A                                                                                        |                                                                                            |
...
| `code`                                                                                     | [models.IdempotencyConflictErrorCode](../../models/idempotency-conflict-error-code.md)     | :heavy_minus_sign:                                                                         | N/A                                                                                        |                                                                                            |
...
```typescript
import { PayloadTooLargeError } from "@auditlocker/sdk/models/errors";
...
| `status`                                                                            | [models.PayloadTooLargeErrorStatus](../../models/payload-too-large-error-status.md) | :heavy_check_mark:                                                                  | N/A                                                                                 |                                                                                     |
...
| `code`                                                                              | [models.PayloadTooLargeErrorCode](../../models/payload-too-large-error-code.md)     | :heavy_minus_sign:                                                                  | N/A                                                                                 |                                                                                     |
...
```typescript
import { NotFoundError } from "@auditlocker/sdk/models/errors";
...
| `status`                                                             | [models.NotFoundErrorStatus](../../models/not-found-error-status.md) | :heavy_check_mark:                                                   | N/A                                                                  |                                                                      |
...
| `code`                                                               | [models.NotFoundErrorCode](../../models/not-found-error-code.md)     | :heavy_minus_sign:                                                   | N/A                                                                  |                                                                      |
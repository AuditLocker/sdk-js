...
```typescript
import { ServiceUnavailableError } from "@auditlocker/sdk/models/errors";
...
| `status`                                                                                 | [models.ServiceUnavailableErrorStatus](../../models/service-unavailable-error-status.md) | :heavy_check_mark:                                                                       | N/A                                                                                      |                                                                                          |
...
| `code`                                                                                   | [models.ServiceUnavailableErrorCode](../../models/service-unavailable-error-code.md)     | :heavy_minus_sign:                                                                       | N/A                                                                                      |                                                                                          |
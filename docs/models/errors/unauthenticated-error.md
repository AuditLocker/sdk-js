...
```typescript
import { UnauthenticatedError } from "@auditlocker/sdk/models/errors";
...
| `status`                                                                          | [models.UnauthenticatedErrorStatus](../../models/unauthenticated-error-status.md) | :heavy_check_mark:                                                                | N/A                                                                               |                                                                                   |
...
| `code`                                                                            | [models.UnauthenticatedErrorCode](../../models/unauthenticated-error-code.md)     | :heavy_minus_sign:                                                                | N/A                                                                               |                                                                                   |
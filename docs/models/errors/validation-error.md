...
```typescript
import { ValidationError } from "@auditlocker/sdk/models/errors";
...
| `status`                                                                | [models.ValidationErrorStatus](../../models/validation-error-status.md) | :heavy_check_mark:                                                      | N/A                                                                     |                                                                         |
...
| `code`                                                                  | [models.ValidationErrorCode](../../models/validation-error-code.md)     | :heavy_minus_sign:                                                      | N/A                                                                     |                                                                         |

...
export type ValidationErrorData = {
   ...
   */
  title: string;
  status: models.ValidationErrorStatus;
  /**
  ...
  code?: models.ValidationErrorCode | undefined;
 ...
 * RFC 9457 Problem Details error response. All error responses follow this format. Match on `code` for programmatic handling; per-status narrowed schemas allOf this base.
 */
export class ValidationError extends AuditLockerError {
  /**
   * URI reference identifying the error type
   */
  type: string;
...
> = z.pipe(
  z.object({
    type: types.string(),
    title: types.string(),
    status: models.ValidationErrorStatus$inboundSchema,
    detail: types.optional(types.string()),
    instance: types.optional(types.string()),
    code: types.optional(models.ValidationErrorCode$inboundSchema),

...
export interface Env {
  AUDITLOCKER_API_KEY?: string | undefined;

  AUDITLOCKER_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodMiniType<Env, unknown> = z.object({
  AUDITLOCKER_API_KEY: z.optional(z.string()),

  AUDITLOCKER_DEBUG: z.optional(z.coerce.boolean()),
});
